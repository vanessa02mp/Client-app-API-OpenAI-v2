...
async function enviarComando(comando) {
    const url = "http://18.206.45.13/API-GPT-e-PHP/endpoints/chat.php";
...
async function insertarEnBaseDatos(respuestaAPI) {
    ...
    try {
        const respuesta = await fetch("http://18.206.45.13/iot-api-php/controllers/AddIotDevice.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function cargarUltimosRegistros() {
    ...
    try {
        ...
        const respuesta = await fetch("http://18.206.45.13/iot-api-php/controllers/GetLastFiveDevices.php");
