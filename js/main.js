...
async function enviarComando(comando) {
    const url = "http://44.215.67.11/API-GPT-e-PHP/endpoints/chat.php";
...
async function insertarEnBaseDatos(respuestaAPI) {
    ...
    try {
        const respuesta = await fetch("http://44.215.67.11/iot-api-php/controllers/AddIotDevice.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function cargarUltimosRegistros() {
    ...
    try {
        ...
        const respuesta = await fetch("http://44.215.67.11/iot-api-php/controllers/GetLastFiveDevices.php");
