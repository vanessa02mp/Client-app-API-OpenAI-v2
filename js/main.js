...
async function enviarComando(comando) {
    const url = "http://35.169.116.17/API-GPT-e-PHP/endpoints/chat.php";
...
async function insertarEnBaseDatos(respuestaAPI) {
    ...
    try {
        const respuesta = await fetch("http://35.169.116.17/iot-api-php/controllers/AddIotDevice.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function cargarUltimosRegistros() {
    ...
    try {
        ...
        const respuesta = await fetch("http://35.169.116.17/iot-api-php/controllers/GetLastFiveDevices.php");
